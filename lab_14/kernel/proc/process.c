...
void print_page_table()
{
	...
	pd = process[0]->page_directory;
	print_debug("the address of 1st page table: ",pd);

	pd2 = *(unsigned long *)pd | DMW_MASK;
	print_debug("the address of 2st page table: ",pd2);

	pt = *(unsigned long *)pd2 | DMW_MASK;
	print_debug("the address of 3st page table: ",pt);
