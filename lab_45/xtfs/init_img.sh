...
../../cross-tool/bin/loongarch64-unknown-linux-gnu-gcc -nostdinc -c bin/pwar/enemy.S -o enemy.o
../../cross-tool/bin/loongarch64-unknown-linux-gnu-gcc -nostdinc -c bin/pwar/enemy_create.S -o enemy_create.o

../../cross-tool/bin/loongarch64-unknown-linux-gnu-ld -z max-page-size=4096 -N -e start -Ttext 0 -o pwar.tmp pwar.o plane.o bullet.o bullet_create.o enemy.o enemy_create.o refresh.o
